...
since the value of a shot at goal is 1 if scored (as this outcome increases the teams score by 1), and 0 otherwise. Thus, if we represent these two outcomes ($\textrm{No Goal}$, $\textrm{Goal}$) as 0 and 1 respectively, then the expected value of a single shot can be calculated as 
...
<!-- <p>
    <img src="article/images/angle.png" alt="Shot Angle" width="710" height="400" />
</p> -->
